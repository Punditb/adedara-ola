...
function ServicesPage() {
  return /* @__PURE__ */ jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsx(PageHero, { eyebrow: "Our Services", title: "A Full-Spectrum Real Estate Practice", subtitle: "Six integrated services that cover the entire lifecycle of a property — from first concept to long-term management." }),
    /* @__PURE__ */ jsx("div", { className: "container-x py-16 md:py-24 space-y-20", children: SERVICES.map((s, i) => /* @__PURE__ */ jsx(ServiceBlock, { service: s, reverse: i % 2 === 1 }, s.title)) }),
...
function ServiceBlock({
  ...
  return /* @__PURE__ */ jsxs("section", { className: `grid lg:grid-cols-2 gap-12 items-start ${reverse ? "lg:[&>*:first-child]:order-2" : ""}`, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "h-14 w-14 rounded-xl bg-primary/10 text-primary flex items-center justify-center", children: /* @__PURE__ */ jsx(Icon, { className: "h-7 w-7" }) }),
      /* @__PURE__ */ jsx("h2", { className: "mt-5 text-3xl md:text-4xl font-bold", children: service.title }),
      /* @__PURE__ */ jsx("p", { className: "mt-4 text-muted-foreground text-lg leading-relaxed", children: service.desc }),
      /* @__PURE__ */ jsxs("div", { className: "mt-8 grid sm:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "eyebrow", children: "Benefits" }),
          /* @__PURE__ */ jsx("ul", { className: "mt-3 space-y-2 text-sm text-secondary", children: service.benefits.map((b) => /* @__PURE__ */ jsxs("li", { children: [
            "• ",
            b
          ] }, b)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "eyebrow", children: "Process" }),
          /* @__PURE__ */ jsx("ol", { className: "mt-3 space-y-2 text-sm text-secondary", children: service.process.map((p, idx) => /* @__PURE__ */ jsxs("li", { children: [
            idx + 1,
            ". ",
            p
          ] }, p)) })
      ...
      /* @__PURE__ */ jsx("a", { href: "/contact", className: "mt-8 inline-flex rounded-md bg-primary px-6 py-3 font-semibold text-primary-foreground hover:bg-primary/90", children: "Discuss your project" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-[var(--surface)] p-6 md:p-8 border border-border", children: [
      /* @__PURE__ */ jsx("p", { className: "eyebrow", children: "FAQ" }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 divide-y divide-border", children: service.faqs.map((f, i) => /* @__PURE__ */ jsx(FAQItem, { q: f.q, a: f.a }, i)) })
    ] })
  ] });
}
function FAQItem({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "py-4", children: [
    /* @__PURE__ */ jsxs("button", { onClick: () => setOpen((v) => !v), className: "w-full flex items-center justify-between gap-4 text-left", children: [
      /* @__PURE__ */ jsx("span", { className: "font-semibold text-navy", children: q }),
      /* @__PURE__ */ jsx(ChevronDown, { className: `h-5 w-5 text-primary transition-transform ${open ? "rotate-180" : ""}` })
    ] }),
    open && /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground leading-relaxed", children: a })
  ] });
}
export {
