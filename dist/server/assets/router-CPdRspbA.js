...
const appCss = "/assets/styles-Cekapo9p.css";
...
const $$splitComponentImporter$7 = () => import("./services-Cb86ZRUA.js");
...
const $$splitComponentImporter$6 = () => import("./properties-DlgVU-xa.js");
const Route$6 = createFileRoute("/properties")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./projects-C_WX_ilS.js");
...
const $$splitComponentImporter$4 = () => import("./investors-feDMOKhf.js");
const Route$4 = createFileRoute("/investors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./insights-CyFJa5DD.js");
const Route$3 = createFileRoute("/insights")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./contact-CQ-g3dYx.js");
...
const $$splitComponentImporter$1 = () => import("./about-CUqiqGnO.js");
...
const $$splitComponentImporter = () => import("./index-DbJDBAY7.js");
...
const PropertiesRoute = Route$6.update({
  id: "/properties",
  path: "/properties",
  getParentRoute: () => Route$9
});
...
const InvestorsRoute = Route$4.update({
  id: "/investors",
  path: "/investors",
  getParentRoute: () => Route$9
});
const InsightsRoute = Route$3.update({
  id: "/insights",
  path: "/insights",
  getParentRoute: () => Route$9
});
