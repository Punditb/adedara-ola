...
function PropertiesPage() {
  ...
  return /* @__PURE__ */ jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "container-x py-16", children: /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: PROPERTIES.map((p, i) => /* @__PURE__ */ jsxs(Link, { to: "/properties/$slug", params: {
      slug: p.slug
