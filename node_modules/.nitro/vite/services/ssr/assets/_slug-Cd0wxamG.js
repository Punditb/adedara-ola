...
import { ArrowLeft, MapPin, Bed, Bath, Maximize2, CheckCircle2 } from "lucide-react";
import { m as mixedImg, r as residentialImg } from "./project-mixed-BXuBy6f9.js";
import { c as commercialImg } from "./project-commercial-ERgHeQtQ.js";
import { R as Route } from "./router-BKkXytYA.js";
import "react";
...
function PropertyDetailPage() {
  ...
  if (!property) {
    return /* @__PURE__ */ jsx(SiteLayout, { children: /* @__PURE__ */ jsxs("section", { "data-reveal": true, className: "container-x py-24", children: [
      /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl font-bold text-navy", children: "Property not found" }),
      /* @__PURE__ */ jsx(Link, { to: "/properties", className: "mt-6 inline-block text-primary font-semibold", children: "Back to properties" })
    ] }) });
  }
  return /* @__PURE__ */ jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsxs("section", { className: "container-x py-10", children: [
      /* @__PURE__ */ jsxs(Link, { to: "/properties", className: "inline-flex items-center gap-2 text-sm font-semibold text-primary mb-6", children: [
        /* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4" }),
        "Back to Properties"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-10 items-start", children: [
        /* @__PURE__ */ jsx("div", { className: "rounded-2xl overflow-hidden border border-border bg-white", children: /* @__PURE__ */ jsx("img", { src: property.img, alt: property.title, className: "w-full aspect-[4/3] object-cover" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("span", { className: "rounded-md bg-primary px-3 py-1 text-sm font-semibold text-primary-foreground", children: property.status }),
          /* @__PURE__ */ jsx("h1", { className: "mt-5 font-display text-4xl font-bold text-navy", children: property.title }),
          /* @__PURE__ */ jsxs("p", { className: "mt-3 flex items-center gap-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4" }),
            property.location
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 text-3xl font-display font-bold text-primary", children: property.price }),
          /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-3 gap-4 border-y border-border py-5 text-sm text-muted-foreground", children: [
            property.beds > 0 && /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-6 leading-relaxed text-muted-foreground", children: property.description }),
          /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsx("h2", { className: "font-display text-xl font-semibold text-navy", children: "Key Features" }),
            /* @__PURE__ */ jsx("ul", { className: "mt-4 grid sm:grid-cols-2 gap-3", children: property.features.map((feature) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-primary mt-0.5 shrink-0" }),
              feature
            ] }, feature)) })
          ] }),
          /* @__PURE__ */ jsx(Link, { to: "/book-consultation", className: "mt-8 inline-flex rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90", children: property.cta })
        ] })
      ] })
    ] }),
