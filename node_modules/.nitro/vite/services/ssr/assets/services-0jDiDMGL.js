...
import { S as SiteLayout, P as PageHero, C as CTASection } from "./Layout-U-XLLFw7.js";
import { ClipboardCheck, Hammer, Wrench, TrendingUp, Building2, DraftingCompass, Cuboid, Zap, Landmark, Handshake, ChevronDown } from "lucide-react";
...
function ServicesPage() {
  return /* @__PURE__ */ jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsx(PageHero, { eyebrow: "Our Services", title: "A Full-Spectrum Real Estate Practice", subtitle: "A variety of integrated services that cover the entire lifecycle of a property, from first concept to long-term management." }),
...
function ServiceBlock({
  ...
  return /* @__PURE__ */ jsxs("section", { "data-reveal": true, className: `grid lg:grid-cols-2 gap-12 items-start ${reverse ? "lg:[&>*:first-child]:order-2" : ""}`, children: [
