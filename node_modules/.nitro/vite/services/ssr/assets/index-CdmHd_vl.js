...
import { a as getSortedPosts, C as CATS } from "./insights-CRXJdPDA.js";
function InsightsPage() {
  const [cat, setCat] = useState("All");
  const sortedPosts = getSortedPosts();
  const list = cat === "All" ? sortedPosts : sortedPosts.filter((p) => p.tag === cat);
  return /* @__PURE__ */ jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsx(PageHero, { eyebrow: "Insights", title: "Thought Leadership for Real Estate Decision-Makers", subtitle: "Discover profitable real estate trends, market insights, and essential updates from industry leaders and policy makers." }),
    /* @__PURE__ */ jsxs("section", { "data-reveal": true, className: "container-x py-12 md:py-16", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: list.map((p, i) => /* @__PURE__ */ jsxs(Link, { to: "/insights/$slug", params: {
        slug: p.slug
