...
import { S as SiteLayout, C as CTASection } from "./_ssr/Layout-CYqs6nPr.mjs";
import { m as mixedImg, c as commercialImg, r as residentialImg } from "./_ssr/project-mixed-Coi09pei.mjs";
import { R as Route } from "./_ssr/router-BQjWON2v.mjs";
import { p as ArrowLeft, M as MapPin, d as Bed, e as Bath, f as Maximize2, n as CircleCheck } from "./_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-x py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10 items-start", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "mt-8 inline-flex rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90", children: property.cta })
        ] })
      ] })
    ] }),
