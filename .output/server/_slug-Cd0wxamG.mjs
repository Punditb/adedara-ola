...
import { S as SiteLayout, C as CTASection } from "./_ssr/Layout-U-XLLFw7.mjs";
import { m as mixedImg, r as residentialImg } from "./_ssr/project-mixed-BXuBy6f9.mjs";
import { c as commercialImg } from "./_ssr/project-commercial-ERgHeQtQ.mjs";
import { R as Route$1 } from "./_ssr/router-BKkXytYA.mjs";
import { o as ArrowLeft, M as MapPin, p as Bed, q as Bath, r as Maximize2, k as CircleCheck } from "./_libs/lucide-react.mjs";
...
function PropertyDetailPage() {
  ...
  if (!property) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SiteLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-24", children: [
