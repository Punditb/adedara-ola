...
const SERVICES = [{
  ...
  faqs: [{
    q: "What is project planning in real estate development?",
    a: "It determines what can be built on a site, how space should be utilized, and the requirements needed for successful development."
  }, {
    q: "Can you help if I am unsure what to build?",
    a: "Yes. We evaluate your land, goals, and market opportunities to recommend suitable development options."
  }, {
    q: "What makes your planning approach different?",
    a: "We combine feasibility, regulatory compliance, and value creation to ensure every project starts on a solid foundation and ends as a landmark address."
  }]
}, {
  icon: Hammer,
  ...
  benefits: ["Quality execution", "Site-specific solutions", "Construction oversight", "Project durability"],
  process: ["Design review", "Site evaluation", "Construction execution", "Project delivery"],
  faqs: [{
  ...
  benefits: ["Improved property value", "Modernized facilities", "Enhanced functionality", "Extended asset lifespan"],
  process: ["Property assessment", "Improvement planning", "Upgrade execution", "Quality review"],
  faqs: [{
  ...
  benefits: ["Better investment decisions", "Balanced project economics", "Improved return potential", "Reduced financial risk"],
  process: ["Project evaluation", "Cost analysis", "Return assessment", "Investment guidance"],
  faqs: [{
  ...
  benefits: ["Regulatory compliance", "Approval support", "Reduced project delays", "Proper documentation"],
  process: ["Document review", "Approval planning", "Application processing", "Permit documentation"],
  faqs: [{
  ...
  benefits: ["Protected asset value", "Efficient operations", "Occupant comfort", "Preventive maintenance"],
  process: ["Property assessment", "Maintenance planning", "Facility management", "Performance review"],
  faqs: [{
  ...
  benefits: ["Functional designs", "Creative solutions", "Planning compliance", "Clear visualization"],
  process: ["Project briefing", "Concept design", "Drawing development", "Design refinement"],
  faqs: [{
  ...
  benefits: ["Realistic visualization", "Better design decisions", "Improved client confidence", "Reduced design revisions"],
  process: ["Concept review", "3D modelling", "Visual refinement", "Animation delivery"],
  faqs: [{
  ...
  benefits: ["Reliable building systems", "Improved energy efficiency", "Enhanced occupant comfort", "Safe installations"],
  process: ["Project assessment", "System design", "Professional installation", "Testing & commissioning"],
  faqs: [{
  ...
  benefits: ["Structural integrity", "Long-term durability", "Safety assurance", "Optimized performance"],
  process: ["Structural assessment", "Design development", "Engineering analysis", "Implementation support"],
  faqs: [{
  ...
  benefits: ["Trusted guidance", "Transparent transactions", "Verified opportunities", "Value-driven decisions"],
  process: ["Client consultation", "Property evaluation", "Transaction support", "Successful completion"],
  faqs: [{
...
function ServiceBlock({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: `grid lg:grid-cols-2 gap-12 items-start ${reverse ? "lg:[&>*:first-child]:order-2" : ""}`, children: [
