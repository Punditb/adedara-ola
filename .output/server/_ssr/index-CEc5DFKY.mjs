...
import { S as SiteLayout, C as CTASection } from "./Layout-U-XLLFw7.mjs";
import { g as getLatestPosts } from "./insights-CRXJdPDA.mjs";
import { c as commercialImg } from "./project-commercial-ERgHeQtQ.mjs";
import { t as teamImg } from "./about-team-B2QLvoL5.mjs";
import { l as ArrowRight, k as CircleCheck, f as Target, E as Eye, d as Compass, C as ClipboardCheck, H as Hammer, D as DraftingCompass, T as TrendingUp, b as Handshake, B as Building2, S as Shield, A as Award, m as Sparkles, e as ChartColumn, Q as Quote, n as Calendar } from "../_libs/lucide-react.mjs";
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "relative overflow-hidden bg-gradient-to-b from-[var(--surface)] via-background to-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x relative grid lg:grid-cols-[1.05fr,1fr] gap-12 lg:gap-16 items-center py-16 md:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/book-consultation", className: "inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3.5 font-semibold text-primary-foreground shadow-[var(--shadow-elegant)] hover:bg-primary/90 transition-all", children: [
            "Book Consultation ",
...
function AboutBand() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-20 md:py-28 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "bg-[var(--surface)] py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x", children: [
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-20 md:py-28", children: [
...
function CorporateFramework() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "bg-[var(--navy)] text-white py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
...
function Insights() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "bg-[var(--surface)] py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: posts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/insights/$slug", params: {
      slug: post.slug
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[4/3] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: post.img, alt: post.title, loading: "lazy", className: "absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-700", width: 1024, height: 768 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-primary uppercase tracking-wider", children: post.tag }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 font-display font-semibold text-navy text-lg leading-snug", children: post.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: post.excerpt }),
