...
import { n as Calendar, l as ArrowRight } from "../_libs/lucide-react.mjs";
...
function InsightsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-12 md:py-16", children: [
