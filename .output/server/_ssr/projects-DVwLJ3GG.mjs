...
function ProjectsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Our Projects", title: "Developments That Define Markets", subtitle: "A growing portfolio of residential, commercial, mixed-use and infrastructure projects across Nigeria." }),
