...
import { S as SiteLayout, P as PageHero } from "./Layout-U-XLLFw7.mjs";
import { M as MapPin, P as Phone, g as Mail, h as Clock } from "../_libs/lucide-react.mjs";
...
function ContactPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Contact", title: "Let's Talk About Your Project", subtitle: "With our wide range of professional competencies and the commitment to quick and effective delivery, you could give us a conspectus of what service you would like us to render to you by using the form below:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-16 grid lg:grid-cols-[1.2fr,1fr] gap-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "container-x pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden border border-border aspect-[16/7] bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { title: "Office location map", src: "https://www.google.com/maps?q=Surulere,Lagos&output=embed", className: "h-full w-full", loading: "lazy", referrerPolicy: "no-referrer-when-downgrade" }) }) })
  ] });
}
function Info({
  icon: Icon,
...
function ContactForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, className: "rounded-2xl bg-white border border-border p-6 md:p-8 shadow-[var(--shadow-card)] space-y-4", children: sent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { name: "service", required: true, className: "mt-1.5 w-full rounded-md border border-border bg-white px-3 py-2.5 text-sm focus:outline-none focus:border-primary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Project Planning" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Project Construction" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Architectural Concepts, Planning and Drawings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "3D Designs and Animations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Mechanical and Electrical Solutions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Structural Design and Development" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Property Sales and Purchases" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Property and Facilities Management" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Real Estate Economics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Land and Building Documentation" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { name: "message", rows: 5, required: true, className: "mt-1.5 w-full rounded-md border border-border bg-white px-3 py-2.5 text-sm focus:outline-none focus:border-primary", placeholder: "Tell us a little about your project..." })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: sending, className: "w-full rounded-md bg-primary px-6 py-3.5 font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-60 disabled:cursor-not-allowed", children: sending ? "Sending..." : "Send message" })
  ] }) });
}
function Field({
  label,
