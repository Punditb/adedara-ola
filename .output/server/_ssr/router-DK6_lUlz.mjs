...
const appCss = "/assets/styles-BeRHxjgJ.css";
...
const $$splitComponentImporter$9 = () => import("./services-D1VxbvHK.mjs");
...
const $$splitComponentImporter$8 = () => import("./properties-DVb4bFSE.mjs");
const Route$8 = createFileRoute("/properties")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./projects-CG2y7yPf.mjs");
...
const $$splitComponentImporter$6 = () => import("./investors-7DpboqVx.mjs");
const Route$6 = createFileRoute("/investors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./insights-Cmq6325y.mjs");
...
const $$splitComponentImporter$4 = () => import("./contact-NwzxZQ0m.mjs");
...
const $$splitComponentImporter$3 = () => import("./book-consultation-DBzosJ1Z.mjs");
const Route$3 = createFileRoute("/book-consultation")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./about-CojFdPCZ.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-Rqmtzoyi.mjs");
...
const $$splitComponentImporter = () => import("../_slug-B9Db_8E_.mjs");
...
const PropertiesRoute = Route$8.update({
  id: "/properties",
  path: "/properties",
  getParentRoute: () => Route$b
});
...
const InvestorsRoute = Route$6.update({
  id: "/investors",
  path: "/investors",
  getParentRoute: () => Route$b
});
...
const BookConsultationRoute = Route$3.update({
