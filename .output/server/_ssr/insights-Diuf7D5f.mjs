...
import { S as SiteLayout, P as PageHero, C as CTASection } from "./Layout-Bv09aVvL.mjs";
...
import { h as Calendar, i as ArrowRight } from "../_libs/lucide-react.mjs";
...
function InsightsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Insights", title: "Thought Leadership for Real Estate Decision-Makers", subtitle: "Market analysis, development insight and investment strategy from our practice." }),
