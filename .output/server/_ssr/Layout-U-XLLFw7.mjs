...
import { X, u as Menu, v as Facebook, w as Linkedin, I as Instagram, x as Twitter, M as MapPin, P as Phone, g as Mail, y as MessageCircle } from "../_libs/lucide-react.mjs";
const logo = "/assets/logo-ZFtjH1AD.png";
const NAV = [
  { to: "/", label: "Home" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x flex items-center gap-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex flex-1 items-center justify-center gap-8", "aria-label": "Primary", children: NAV.map((item) => {
...
function Footer() {
  ...
  const [subscribing, setSubscribing] = reactExports.useState(false);
  const [subscribeMessage, setSubscribeMessage] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-[var(--navy)] text-white/80 mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-6 flex gap-2 max-w-sm", onSubmit: handleSubscribe, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "email",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: subscribing ? "Subscribing..." : "Get Updates"
            }
          )
        ] }),
        subscribeMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-white/70", children: subscribeMessage }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:adedaraolaproperties@gmail.com", className: "block hover:text-white text-xs", children: "adedaraolaproperties@gmail.com" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:olaadedarabrand@gmail.com", className: "block hover:text-white text-xs", children: "olaadedarabrand@gmail.com" })
            ] })
          ] })
        ] })
      ] })
...
const WHATSAPP_MESSAGE = "Hello Adedara Ola & Co., I visited your website and would like to make an enquiry about your real estate services.";
...
function SiteLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { ref: mainRef, children }),
