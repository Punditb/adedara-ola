...
import { S as SiteLayout, C as CTASection } from "./Layout-CtTmM7iL.mjs";
...
import { i as ArrowRight, l as CircleCheck, g as Target, E as Eye, e as Compass, C as ClipboardCheck, H as Hammer, W as Wrench, T as TrendingUp, B as Building2, S as Shield, A as Award, m as Sparkles, f as ChartColumn, Q as Quote, h as Calendar } from "../_libs/lucide-react.mjs";
...
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-x py-20 md:py-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground mt-6", children: "Sample testimonials — to be replaced with real client reviews." })
  ] });
}
function Insights() {
  const posts = [{
