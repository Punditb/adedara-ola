...
import { i as CalendarCheck, j as MessageSquareText, F as FileText, h as Clock } from "../_libs/lucide-react.mjs";
...
function BookConsultationPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "container-x pt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-5", children: [{
      icon: CalendarCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "container-x py-12 md:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden border border-border bg-white shadow-[var(--shadow-card)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { src: "https://cal.com/adedarao/consultation-meeting", title: "Book a consultation with Adedara Ola & Co.", className: "w-full min-h-[850px]" }) }) })
  ] });
}
export {
