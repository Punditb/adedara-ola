...
import { T as TrendingUp, d as Compass, S as Shield, e as ChartColumn, f as Target, A as Award } from "../_libs/lucide-react.mjs";
...
const investorsImg = "/assets/investors-C9Dfj_2X.jpg";
function InvestorsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-reveal": true, className: "bg-[var(--surface)] py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x", children: [
...
function InvestorForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-reveal": true, className: "container-x py-16 md:py-24 grid lg:grid-cols-[1fr,1.2fr] gap-12 items-start", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, className: "rounded-2xl bg-white border border-border p-6 md:p-8 shadow-[var(--shadow-card)] space-y-4", children: status === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Full name", name: "fullName" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Organization", name: "organization", required: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Email", type: "email", name: "email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Phone", name: "phone", required: false })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "ticketSize", className: "text-sm font-semibold text-navy", children: "Ticket size" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "ticketSize", name: "ticketSize", className: "mt-1.5 w-full rounded-md border border-border bg-white px-3 py-2.5 text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "investmentFocus", className: "text-sm font-semibold text-navy", children: "Investment focus" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { id: "investmentFocus", name: "investmentFocus", rows: 4, className: "mt-1.5 w-full rounded-md border border-border bg-white px-3 py-2.5 text-sm", placeholder: "Residential, commercial, mixed-use, expected horizon..." })
      ] }),
      status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rounded-md bg-red-50 px-4 py-3 text-sm text-red-700", children: "Sorry, your inquiry could not be submitted. Please try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: status === "loading", className: "w-full rounded-md bg-primary px-6 py-3 font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-70 disabled:cursor-not-allowed", children: status === "loading" ? "Submitting..." : "Submit inquiry" })
    ] }) })
  ] });
}
function Field({
