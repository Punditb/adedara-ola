...
const Bath = createLucideIcon("bath", __iconNode$B);
const __iconNode$A = [
...
const ClipboardCheck = createLucideIcon("clipboard-check", __iconNode$s);
const __iconNode$r = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const Cuboid = createLucideIcon("cuboid", __iconNode$p);
const __iconNode$o = [
...
const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$o);
const __iconNode$n = [
  [
    "path",
    {
...
const MessageSquareText = createLucideIcon("message-square-text", __iconNode$a);
const __iconNode$9 = [
  [
    "path",
    {
