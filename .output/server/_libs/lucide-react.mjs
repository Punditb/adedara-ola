...
const Bath = createLucideIcon("bath", __iconNode$z);
const __iconNode$y = [
...
const Cuboid = createLucideIcon("cuboid", __iconNode$o);
const __iconNode$n = [
...
const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$n);
const __iconNode$m = [
  [
    "path",
    {
