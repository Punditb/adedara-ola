...
const Bath = createLucideIcon("bath", __iconNode$C);
const __iconNode$B = [
...
const Bed = createLucideIcon("bed", __iconNode$B);
const __iconNode$A = [
...
const Cuboid = createLucideIcon("cuboid", __iconNode$q);
const __iconNode$p = [
...
const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
